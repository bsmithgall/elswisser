defmodule MaxWeightMatching.GraphTest do
  ...
  describe "new/1" do
    ...
    test "stores edges as map with index keys" do
      edges = [{0, 1, 10}, {2, 3, 5}, {1, 2, 8}]
      graph = Graph.new(edges)
      assert graph.edges == %{0 => {0, 1, 10}, 1 => {2, 3, 5}, 2 => {1, 2, 8}}
