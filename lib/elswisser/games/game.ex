defmodule Elswisser.Games.Game do
  ...
  schema "games" do
    ...
    has_many(:players, Elswisser.Games.GamePlayers)

    has_one(:white_player, through: [:players, :player], where: [color: :white])
    has_one(:black_player, through: [:players, :player], where: [color: :black])
