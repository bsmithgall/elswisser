defmodule Blossom.MaxWeightMatching.Blossom do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> trivial = Blossom.MaxWeightMatching.Blossom.Trivial.new(5)
      iex> blossoms = %{trivial.id => trivial}
      iex> Blossom.MaxWeightMatching.Blossom.vertices(trivial.id, blossoms)
      [5]
  """
