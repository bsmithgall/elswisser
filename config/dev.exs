...
config :elswisser, Elswisser.Repo,
  database: Path.expand("../elswisser_dev.db", Path.dirname(__ENV__.file)),
  pool_size: 5,
  stacktrace: true,
...
config :elswisser, ElswisserWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "YB+ToNWQM8/I2CDUnCRNvAHHwoCgMgTmfGfRMHVUZN+qOvZBL4n/aWY/H1qv7Noo",
  watchers: [
...
config :elswisser, dev_routes: true
